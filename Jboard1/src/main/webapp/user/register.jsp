                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button id="btnCheckUid" type="button"><img src="../images/chk_id.gif" alt="중복확인"></button>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <button type="button" class="btnzip" onclick="zipcode()"><img src="../images/chk_post.gif" alt="우편번호 찾기"></button>
                                </div>
                                <div>
