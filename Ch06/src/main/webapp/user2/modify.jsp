	...
	<body>
		...
		<form action="/Ch06/user2/modifyProc.jsp" method="post">
			<table border="1">
				<tr>
					<td>아이디</td>
					<td><input type="text" name="uid" readonly value="<%= vo2.getUid()%>"></td>
				</tr>
				<tr>
					<td>이름</td>
					<td><input type="text" name="name" value="<%= vo2.getName() %>"></td>
				</tr>
				<tr>
					<td>연락처</td>
					<td><input type="text" name="hp" value="<%= vo2.getHp() %>"></td>
				</tr>
				<tr>
					<td>나이</td>
					<td><input type="number" name="age" value="<%= vo2.getAge() %>"></td>
				</tr>
				<tr>
