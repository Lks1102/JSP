...
public class SQL {
	...
	public final static String UPDATE_USER_INFO = "UPDATE `User` SET `nick` = ?, `name` = ? WHERE `uid` = ?";
	...
	public final static String SELECT_ORDER = "SELECT * FROM `Order` WHERE `orderNo`=?";
	
	public final static String SELECT_ORDERS = "SELECT a.*, b.pName, c.`name` "
												+ "FROM `Order` AS a "
												+ "JOIN `Product` AS b "
	...
	public final static String DETAIL_ORDER = "SELECT a.*, b.`pName`, c.`name` "
											+ "FROM `Order` AS a "
											+ "JOIN `Product` AS b "
											+ "ON a.`orderProduct` = b.`pNo` "
											+ "JOIN `User` AS c "
