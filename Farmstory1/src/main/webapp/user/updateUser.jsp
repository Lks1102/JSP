...
<div id="user">
	<section class="updateUser">
        <form id="formUser" action="/Farmstory1/user/updateUserProc.jsp" method="post">
            <table border="1">
                <caption>내정보</caption>
                <tr>
                    <td>아이디</td>
                ...
                <tr>
                    <td>비밀번호 변경</td>
                    <td>
                        <input type="password" name="pass1" placeholder="변경 할 비밀번호 입력"/>                            
                    </td>
                </tr>
                <tr>
                    <td>비밀번호 확인</td>
            ...
            <table border="1">
                ...
                <tr>
                    <td>이름</td>
                    <td>
                        <input type="text" name="name" value="<%= sessUser.getName() %>"/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="nick" value="<%= sessUser.getNick() %>"/>
            ...
            <div>
                ...
                <input type="submit"   class="btnSubmit" value="정보수정"/>
            </div>
        </form>
    </section>
</div>
